<template>
    <f7-page>
        <tab>
            <tab-item selected @on-item-click="itemTabClick(1)">会议议案</tab-item>
            <tab-item @on-item-click="itemTabClick(0)">会议信息</tab-item>
        </tab>
        <div v-show="itemshowhide" v-for="(item, index) in information" :key="index">
            <div v-if="information.length != 0">
                ...
                <div v-if="item.MIsSign !== '否' && signin">
                    <div class="fixed">
                        <x-button type="primary" @click.native="Signin">签到</x-button>
                    </div>
                </div>
            </div>
        </div>
        <div v-show="!itemshowhide">
            <div class="conferenceBill">
                    ...
                    <div v-if="information.length>0 && information[0].MIsSign !== '否' && signin">
                    ...
                    <div class="textbox" v-for="(item, index) in DmpListCount" :key="index">
                    ...
                    <div>
                        <div
                            ...
                            v-for="(item, index) in conferenceBill"
                            :key="index"
                        >
                            <div class="title">
                            ...
                            <div class="flexBox1">
                                <!-- <div class="color333" @click="goMaterials(item)">查看材料</div>
                            <div
