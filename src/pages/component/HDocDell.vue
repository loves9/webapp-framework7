...
export default {
    ...
    methods: {
        ...
        viewDoc: function(FileId, FileName) {
            ...
            var fileUrl = process.env.PREVIEW_FILE_URL + FileId;
            var realUrl = encodeURIComponent(fileUrl, "utf-8");


            var androidurl = process.env.PREVIEW_FILE_URL_SERVER + realUrl + "&name=" + fileName + "&enableZoom=true&method=200";
            var iosurl = process.env.PREVIEW_FILE_URL_SERVER + realUrl + "&name=" + fileName + "&enableZoom=true";
